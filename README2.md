...
#### The *"main" function*
enters an infinite loop to continuously check for incoming SMS messages. It reads the modem responses, checks if there are any unread messages, and processes each as they arrive
